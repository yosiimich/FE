...
const rows = [
    createData(240517, '작성 내역 1'),
    createData(240517, '작성 내역 2'),
    createData(240517, '작성 내역 3'),
];
        ...
        <PageContainer>
            <TableContainer>
                <StyledTable>
                    <thead>
                        <tr>
                            <StyledTableCell>작성 날짜</StyledTableCell>
                            <StyledTableCell>작성 내역</StyledTableCell>
                        </tr>
                    </thead>
                    <tbody>
                        {rows.map((row, index) => (
