...
const rows = [
    createData(240517, '검색 문장 1', '분석 내역 1'),
    createData(240517, '검색 문장 2', '분석 내역 2'),
    createData(240517, '검색 문장 3', '분석 내역 3'),
];
        ...
        <PageContainer>
            <TableContainer>
                <StyledTable>
                    <thead>
                        <tr>
                            <StyledTableCell>검색 날짜</StyledTableCell>
                            <StyledTableCell>검색 문장</StyledTableCell>
                            <StyledTableCell>분석 내역</StyledTableCell>
                        </tr>
                    </thead>
                    <tbody>
                        {rows.map((row, index) => (
...
export default Searchlistadmin;
